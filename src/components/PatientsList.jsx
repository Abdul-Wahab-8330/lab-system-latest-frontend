                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p
                                        ...
                                        style={{ color: '#DBEAFE' }}
                                    >
                                        Manage registered Patients &amp; Print Reports
                                    </p>
                                </div>
                            </div>
                                                    ...
                                                    <TableCell>
                                                        <div className="flex gap-2 ">
                                                            ...
                                                            <Button
                                                                variant="outline"
                                                                size="sm"
                                                                className="bg-green-50 border-green-200 hover:bg-green-100 hover:border-green-300 text-green-700 rounded-md shadow-sm hover:shadow-md transition-all duration-200"
                                ...
                                <div className="text-center text-xs text-gray-700 space-y-0.5">
                                    <p className="font-medium">
                                        {info?.labID === "demo_lab_system"
                                            ? `Phone: ${info?.phoneNumber || "-"} | Email: ${info?.email || "-"}`
