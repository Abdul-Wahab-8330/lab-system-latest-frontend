...
//                     <Table>
//                         <TableHeader className="bg-gray-300 font-normal">
//                             <TableRow>
...
//                                 <TableHead className="font-bold">Reset Result</TableHead>
//                             </TableRow>
//                         </TableHeader>
//                         <TableBody>
//                             {filteredPatients
...
//                                             >
//                                                 <RefreshCcw className="mr-1" /> Delete & Resubmit
//                                             </Button>
//                                         </TableCell>
//                                     </TableRow>
//                                 ))}
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-2">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Print Preview Dialog */}
                /* Print Preview Dialog - Updated to match actual print design */
                <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
                    <DialogContent className="max-w-5xl h-[95vh] overflow-auto bg-white p-6 rounded-2xl border-0 shadow-2xl">
                        <DialogHeader className="pb-4">
                            <DialogTitle className="text-2xl font-bold text-gray-900 flex items-center">
